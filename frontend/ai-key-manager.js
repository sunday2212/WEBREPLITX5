...
(function () {
  ...
  const PROVIDERS = {
    gemini: { label: 'Google Gemini', placeholder: 'AIza…', model: 'gemini-2.0-flash' },
    groq: { label: 'Groq AI', placeholder: 'gsk_…', model: 'llama-3.3-70b-versatile' },
    openai: { label: 'ChatGPT (OpenAI)', placeholder: 'sk-…', model: 'gpt-4o-mini' },
  };
  ...
  async function saveAISettings(provider, key) {
    ...
    const profilePayload = { ai_provider: provider, [providerColumn]: key };
